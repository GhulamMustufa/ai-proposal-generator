...
const companies = [
  ...
  { name: 'Equinox', atsProvider: 'smartrecruiters', atsBoardToken: 'equinox' },
  {
    ...
    atsBoardToken: 'skechers',
  },
  {
    name: 'Colliers',
    atsProvider: 'smartrecruiters',
    atsBoardToken: 'colliers',
  },
  {
    name: 'Kincentric',
    atsProvider: 'smartrecruiters',
    atsBoardToken: 'kincentric',
  },
  {
    name: 'Avery Dennison',
    atsProvider: 'smartrecruiters',
    atsBoardToken: 'averydennison',
  },
  ...
  {
    name: 'Tractor Ventures',
    atsProvider: 'workable',
    atsBoardToken: 'tractor-ventures',
  },
